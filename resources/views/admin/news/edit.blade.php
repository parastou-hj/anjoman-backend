...
<div class="card">
    <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="description" class="form-control" rows="3" placeholder="توضیح کوتاهی درباره خبر (حداکثر 500 کاراکتر)" maxlength="500" required>{{ old('description', $news->description) }}</textarea>
        ...
        <div class="form-group">
            ...
            <textarea name="content" class="form-control tinymce-editor" rows="15">{{ old('content', $news->content) }}</textarea>
